...
"""
From Daniel Holden's codebase: see http://theorangeduck.com,
e.g. publication "A Deep Learning Framework For Character
Motion Synthesis and Editing" code. License: (cc by-sa 3.0).
"""
